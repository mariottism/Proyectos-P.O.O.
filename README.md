...
Por qué: Gracias a esto, cuando el Hospital recorre los equipos para contar pacientes, el paciente ya aparece en la lista del equipo automáticamente. Si no haces esto, el reporte numberPatientsTeam() saldría en 0.

El uso de contains:

En el Main: Verás que a veces se intenta asignar el mismo doctor varias veces.

Por qué: Es un mecanismo de seguridad. En POO siempre debemos validar que los datos no se dupliquen si la lógica del negocio no lo permite.
